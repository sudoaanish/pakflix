...
Download the latest release APK from [GitHub Releases](https://github.com/sudoaanish/pakflix/releases). Release APKs use names like `pakflix-v0.3.3-release.apk`.
...
# Install PAKFLIX APK
adb install -r pakflix-v0.3.3-release.apk
